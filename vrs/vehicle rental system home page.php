<html>
  <head>
      <link rel="stylesheet" href="vehicle rental system home page.css">
  ...
  <header style="border-radius: 25px;background-image: url(headrer.jpg);">
      ...
      <center><h1 style="background-color: rgb(0, 0, 0); color:white"><b><i>Car2Go</i></b></h1>
        ...
        <a href="index.php" button class="login-button">Login</button></a>
        <a href="index.php"  button class="signup-button">Signup</button></a> 
  
      </header><br><br>

      <body style="background-image: url(carrr.jpg);"><br>
        <div >
        ...
        <div class="paragraph">
          <p><b>Welcome to Car2Go, your premier vehicle rental system. Whether you need a car, van, or SUV, we have a wide selection of vehicles to choose from. With our user-friendly platform, you can quickly book a vehicle, enjoy competitive prices, and experience excellent customer service. Take advantage of our convenient pickup and drop-off locations and start your adventure with Car2Go today!</b></p>
        </div>
        </div>
        <br>        
        <div class="slider-container">
          ...
          <div class="slider-image-container">
              <img class="slider-image" src="bike.jpg">
              <div class="image-text"><h1>Car2Go</h1></div>
          </div>
        ...
        <div class="features-container">
            <div class="feature">
                <img src="vehicle icon1.png" alt="Icon">
                <p>Over 200+ Vehicles</p>
            </div>
            <div class="feature">
                <img src="insuarance icon.png" alt="Icon">
                <p>Insurance Included</p>
            </div>
            <div class="feature">
                <img src="save money icon.png" alt="Icon">
                <p>Save Money</p>
            </div>
            <div class="feature">
            ...
            <div class="feature">
                <img src="rating icon.png" alt="Icon">
                <p>Customer Ratings</p>
            </div>
        </div>
    
        <div class="reviews-container">
            <a href="feedback.php" button class="reviews-btn">Reviews and Ratings</button></a>
        </div><br>
    
        <div class="banner-ad">
          <img src="banner.jpeg" alt="Banner Ad">
          <div class="banner-content">
            <h3>Rent a Vehicle Today!</h3>
            <p>Explore our wide range of vehicles for rent and enjoy your journey.</p>
            <a href="vehicle.php" class="btn">Learn More</a>
          </div>
        </div>
        
        
    
        <script src="vehicle rental system home page.js"></script>
...
<br><br><br><br><br>
      ...
      <div >
        <p class="copyright">
          &copy; 2023 Car2Go. All rights reserved.
